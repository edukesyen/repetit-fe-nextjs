  ...
  return (
    <div className="rounded-3xl py-5 px-5 flex flex-col gap-4 border-2 border-[#C6C6D0]">
      ...
      <div className="flex items-center justify-between">
        <span className="font-bold">{calculateRemainingTime(sessionDetail.datetimeIso)} sebelum mulai</span>
    ...
    <div className="rounded-3xl py-8 px-5 flex flex-col gap-4 border-2 border-[#C6C6D0]">
      <div className="flex flex-col gap-4">
        {reservedMentoringSession.map((sessionDetail, index) => (
          <div key={index} className="flex flex-col gap-1 p-3 bg-white rounded-2xl border-[1.5px] border-[#C6C6D0] drop-shadow-[0_4px_0_rgba(214,214,208,1)]">
